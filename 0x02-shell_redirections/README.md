...
>   * [More Info](#more-info)
>   * [Tasks](#tasks)
>        * [0. Hello World.](#0-hello-world-sub0-hello_world0-hello_worldsub)
>        * [1. Confused smiley.](#1-confused-smiley-sub1-confused_smiley1-confused_smileysub)
>        * [2. Let's display a file.](#2-lets-display-a-file-sub2-hellofile2-hellofilesub)
>        * [3. What about 2?.](#3-what-about-2-sub3-twofiles3-twofilessub)
>        * [4. Last lines of a file.](#4-last-lines-of-a-file-sub4-lastlines4-lastlinessub)
>        * [5. I'd prefer the first ones actually.](#5-id-prefer-the-first-ones-actually-sub5-firstlines5-firstlinessub)
>        * [6. Line #2.](#6-line-2-sub6-third_line6-third_linesub)
>        * [7. It is a good file that cuts iron without making a noise.](#7-it-is-a-good-file-that-cuts-iron-without-making-a-noise-sub7-file7-filesub)
>        * [8. Save current state of directory.](#8-save-current-state-of-directory-sub8-cwd_state8-cwd_statesub)
>        * [9. Duplicate last line.](#9-duplicate-last-line-sub9-duplicate_last_line9-duplicate_last_linesub)
>        * [10. No more javascript.](#10-no-more-javascript-sub10-no_more_js10-no_more_jssub)
>        * [11. Don't just count your directories, make your directories count.](#11-dont-just-count-your-directories-make-your-directories-count-sub11-directories11-directoriessub)
>        * [12. What’s new.](#12-whats-new-sub12-newest_files12-newest_filessub)
>        * [13. Being unique is better than being perfect.](#13-being-unique-is-better-than-being-perfect-sub13-unique13-uniquesub)
>        * [14. It must be in that file.](#14-it-must-be-in-that-file-sub14-findthatword14-findthatwordsub)
>        * [15. Count that word.](#15-count-that-word-sub15-countthatword15-countthatwordsub)
>        * [16. What's next?.](#16-whats-next-sub16-whatsnext16-whatsnextsub)
>        * [17. I hate bins.](#17-i-hate-bins-sub17-hidethisword17-hidethiswordsub)
>        * [18. Letters only please.](#18-letters-only-please-sub18-letteronly18-letteronlysub)
>        * [19. A to Z.](#19-a-to-z-sub19-az19-azsub)
>        * [20. Without C, you would live in hiago.](#20-without-c-you-would-live-in-hiago-sub20-hiago20-hiagosub)
>        * [21. esreveR.](#21-esrever-sub21-reverse21-reversesub)
>        * [22. DJ Cut Killer.](#22-dj-cut-killer-sub22-users_and_homes22-users_and_homessub)
>        * [23. Empty casks make the most noise.](#23-empty-casks-make-the-most-noise-sub100-empty_casks100-empty_caskssub)
>        * [24. A gif is worth ten thousand words.](#24-a-gif-is-worth-ten-thousand-words-sub101-gifs101-gifssub)
>        * [25. Acrostic.](#25-acrostic-sub102-acrostic102-acrosticsub)
>        * [26. The biggest fan.](#26-the-biggest-fan-sub103-the_biggest_fan103-the_biggest_fansub)
...
Format:
```shell
host    When possible, the hostname making the request. Uses the IP address if thehostname was unavailable.
